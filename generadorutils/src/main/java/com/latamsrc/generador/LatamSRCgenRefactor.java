/*
 * Created by Cristian Gonzalez Remoded And Update By Gatesccn LatamSRC on 15/12/23 13:38
 *  Copyright (c) LatamSRC 2024 update . All rights reserved.
 */

package com.latamsrc.generador;
...
import com.latamsrc.generador.constants.AppConstants;

import org.json.JSONArray;
import org.json.JSONObject;

public class LatamSRCgenRefactor {
    private static final String TAG = "NetFreeMXGen";
    @SuppressLint("StaticFieldLeak")
    private static LatamSRCgenRefactor instance;
    ...
    private LatamSRCgenRefactor() {}

    public static LatamSRCgenRefactor getInstance() {
        if (instance == null) {
            instance = new LatamSRCgenRefactor();
        }
        return instance;
    }
